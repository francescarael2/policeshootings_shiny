...
sh_shooting_data <- get(load("shooting_data.RData"))
sh_state_data <- get(load("state_data.RData"))
sh_race_data <- get(load("race_data.RData"))
sh_rolling_data <- get(load("rolling_data.RData"))
original_data <- get(load("original_data.RData"))
